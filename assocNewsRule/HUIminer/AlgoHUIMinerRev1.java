 ...
 *
 * Modification: Added function of output local utility array for each HUI
 *  
 * @see UtilityList
 * @see Element
 * @author Xing Zhao modified version based on Philippe Fournier-Viger
 */
public class AlgoHUIMinerRev1 {
	...
	private void huiMiner(int [] prefix, UtilityList pUL, List<UtilityList> ULs, int minUtility)
		...
		for(int i=0; i< ULs.size(); i++){
			...
			int[] utilityArray = new int[prefix.length + 1];
	 ...
	 */
	private void writeOutAll(int[] huiItemset, int utility, int[] utilityArray) throws IOException {
