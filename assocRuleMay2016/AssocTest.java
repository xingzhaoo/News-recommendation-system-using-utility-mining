...
public class AssocTest {
	...
	public static void main(String[] args) throws IOException {
			    ...
			    String input = "../trans_HUImined_UARY3.txt";
			    String output = "../trans_accoc_HUImined22.txt";
				//String input = ".//evalsrt_TRAINING_5dev2_trans_HUImined_UARY.txt";
				//String output = ".//evalsrt_TRAINING_5dev2_trans_Assoc_HUImined_c60r.txt";
			...
			/*	
				String input = ".//5dev2_trans_HUImined_UARY.txt";
				String output = ".//5dev2_trans_Assoc_HUIminedTop1.txt";
				String mapdb = ".//postprocessDB.txt";
				String textput = ".//5dev2_trans_Assoc_HUImined_headlinesTop1.txt";
			*/

				
				double min_utility_conf = 0.10; 
				//AssocRulesHUIminerSSG algoShane = new AssocRulesHUIminerSSG();
				AssocRulesHUIminerSYSG algoShane = new AssocRulesHUIminerSYSG();
				//AssocRulesHUIminerPrint algoShane = new AssocRulesHUIminerPrint();
				//AssocRulesHUIminerSY algoShane = new AssocRulesHUIminerSY();
				//AssocRulesHUIminer algoShane = new AssocRulesHUIminer();
				//AssocRulesHUIminerX algoShane = new AssocRulesHUIminerX();
				//AssocRulesHUIminerAn algoShane = new AssocRulesHUIminerAn();
