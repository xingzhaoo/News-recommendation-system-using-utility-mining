 ...
 *
 */
public class AssocTestZ {

	public static void main(String[] args) throws IOException {
		
			
			    String input = "../trans_HUImined_UARY29.txt";
			    String output = "../trans_accoc_HUIminedZ.txt";
			...
			*/
				...
				double min_utility_conf = 0.60; 
				//AssocRulesHUIminerSYSG algoShane = new AssocRulesHUIminerSYSG();
				//AssocRulesHUIminerSY algoShane = new AssocRulesHUIminerSY();
				AssocRulesHUIminerZ algoShane = new AssocRulesHUIminerZ();
				//AssocRulesHUIminerY algoShane = new AssocRulesHUIminerY();
