		...
		try {
			...
			while ((thisLine = myInput.readLine()) != null) {
				...
				for(int i = 0; i < items.length; i++){
					...
					// output visited news -> {recommend news set}
					//buffer.append(items[i] + ":");
					//buffer.append(newsRecommend.trim() + "\n");
				}
